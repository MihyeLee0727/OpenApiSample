...
class MergedBenchmark {

    @get:Rule
    val benchmarkRule = BenchmarkRule()

    @get:Rule
    val mergedActivityRule = ActivityTestRule(TestMergedListActivity::class.java)
    ...
    @Before
    fun setup() {
        mergedActivityRule.runOnUiThread {
            mergedActivityRule.activity.adapter.submitList(null)
            mergedActivityRule.activity.adapter.submitList(getRandomList())
        }
    }
    ...
    @UiThreadTest
    @Test
    fun mergedListScroll() {
        val recyclerView = mergedActivityRule.activity.list
